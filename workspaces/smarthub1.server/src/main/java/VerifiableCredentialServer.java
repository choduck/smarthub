...
import com.wooribank.blockchain.verifiablecredential.VerifiableCredentialServerImpl;
 ...
 */
public class VerifiableCredentialServer {
	...
	private void start() throws IOException, URISyntaxException {
		...
		server = NettyServerBuilder.forPort(port)
					...
					.build())
					*/
				.addService(new VerifiableCredentialServerImpl())
				.build()
				.start();
		...
		Runtime.getRuntime().addShutdownHook(new Thread() {
			...
			public void run() {
				...
				VerifiableCredentialServer.this.stop();
	...
	public static void main(String[] args) throws IOException, InterruptedException, URISyntaxException {
		final VerifiableCredentialServer server = new VerifiableCredentialServer();
		server.start();
