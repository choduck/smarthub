...
//수정
function fnGoDetail(seqNo){
	commform.setValue("seqNo", seqNo);
	commform.setAction("/member/detail.do");
	commform.setMethod("GET");
	commform.submit();
}
                             ...
                             <tbody>
								...
								<c:forEach var="board" items="${memberList}" varStatus="status">
	                                <tr>
	                                    ...
	                                    <td><a href="#" onClick="javascript:fnGoDetail('<c:out value="${board.seqNo}" />');"><c:out value="${board.residNo}" />-*******</a></td>
