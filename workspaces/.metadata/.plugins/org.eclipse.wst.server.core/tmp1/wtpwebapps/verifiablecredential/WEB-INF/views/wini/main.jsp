                                ...
                                <div class="col">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="step2" class="tab-pane fade">
                                            ...
                                            <div class="text-center">
                                                <button class="btn btn-previous" data-toggle="tab" href="#step1" onclick="onStep1();">이전</button>
                                                <button class="btn btn-next"  data-toggle="tab" href="#step3" onclick="onStep3();">다음</button>
                                            </div>
                                        </div>
                                        <div id="step3" class="tab-pane fade">
                                            ...
                                            <div class="text-center">
                                                <button class="btn btn-previous" data-toggle="tab" href="#step2" onclick="disConnect();onStep2();">이전</button>
                                                <button class="btn btn-next" data-toggle="tab" href="#step4" onclick="onStep4();">다음</button>
                                            </div>
                                        </div>
                                        <div id="step4" class="tab-pane fade">
                                            ...
                                            <div class="text-center">
                                                <button class="btn btn-previous" data-toggle="tab" href="#step3" onclick="onStep3();">이전</button>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        <img src="d://photo//photo.png" style="height:162px; border:3px solid #ddd;" class="mt-5 mb-3">
                                                        <h6 class="text-center p-3" style="font-size:18px;"><div id="korNm" style="color: #007bff;">김우리</div> 고객님의 모바일 신분증 인증정보가<br>연동되었습니다.</h6>
                                                    </div>
                                                    <div class="col-12">
                                                        <table class="table table-bordered table-in-modal-2">
                                                            <tbody>
                                                                <tr>
                                                                    <th>한글이름</th>
                                                                    <td><div id="kornm2">김우리</div></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>주민등록번호</th>
                                                                    <td>900406-1742933</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>주소</th>
                                                                    <td>서울시 중구 소공로 51</td>
