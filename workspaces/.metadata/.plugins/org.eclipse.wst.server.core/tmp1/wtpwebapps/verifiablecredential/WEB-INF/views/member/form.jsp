                         ...
                         <table class="table table-sm table-bordered table-striped">
                             <tbody>
                                 <tr>
                                     ...
                                     <td>
                                         <form:input path="mbNm" id="mbNm" class="form-control w-100" /> 
                                     </td>
                                     <td class="bg-dark text-light text-center">주민등록번호</td>
                                     <td>
                                         <form:input path="residNo" id="residNo" class="form-control w-100" maxlength="13" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onChange="this.value=this.value.replace(/[^0-9]/g,'')" />  
                                     </td>
                                 </tr>
                                 <tr>
                                     <td class="bg-dark text-light text-center">휴대전화번호</td>
                                     <td>
                                         <form:input path="mobileNo" id="mobileNo" class="form-control w-100" maxlength="11" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onChange="this.value=this.value.replace(/[^0-9]/g,'')" />
                                     </td>
                                     <td class="bg-dark text-light text-center">가입일</td>
                                     <td colspan="3">
                                         <form:input path="joinDate" id="joinDate" class="form-control" maxlength="8" style="width:150px;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onChange="this.value=this.value.replace(/[^0-9]/g,'')" />
                                     </td>  
                                 </tr>
                             </tbody>
                         </table>
                                         ...
                                         <div class="input-group">
	                                        ...
	                                        &nbsp;
                                             <div class="input-group-append">
                                                 <a href="#" id="btn_certiFieldAdd" class="btn btn-sm btn-info"><i class="fa fa-plus fa-fw"></i>추가</a>
                                             </div>
                                         </div>
                                     </td>
                                 </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
											...
											<input type="text" name="arryFieldCnt" class="form-control" value="<c:out value='${memberCertiField.fieldCnt}' />">
                                        </td>
                                    </tr>
                                    </c:if>
                                    </c:forEach>
