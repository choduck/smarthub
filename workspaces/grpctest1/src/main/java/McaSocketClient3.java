...
//        }
        ...
        try {
            ...
            //정보 입력
            //영업점ID
            hubInfo.put("branch_id", "10101013");
            //스마트허브IP
            hubInfo.put("hub_ip", "192.168.000.016");
            //요청 테스크 설정
            hubInfo.put("task_id", "3");
            ...
            pw.flush();
            InputThread3 it = new InputThread3(sock,br);
            it.start();
            String line = "";
            ...
            for(int i=0 ; i < 10;i++) {
	            try {
	                ...
	                hubInfo.put("branch_id", "10101013");
	                //스마트허브IP
	                hubInfo.put("hub_ip", "192.168.000.333");
	                //요청 테스크 설정
	                hubInfo.put("task_id", "3");
...
class InputThread3 extends Thread{
    ...
    public InputThread3(Socket sock,BufferedReader br) {
        this.sock = sock;
        this.br = br;
    }
    public void run() {
